...
private:
	...
	//ListView传入的不能为Set转出的右值，必须保存TArray参考[Slate(二):SListView - 知乎](https://zhuanlan.zhihu.com/p/341411218)
	...
	TSharedRef<ITableRow> GetGenerateRowData(TSharedPtr<FAssetData> DisplayAssetData,
	...
	void HandleTextContainerDoubleClicked(const FGeometry& InGeometry, const FPointerEvent& InPointerEvent,
